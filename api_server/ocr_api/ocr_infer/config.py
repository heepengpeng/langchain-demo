...
def create_parser():
    ...
    parser.add_argument(
        ...
        default="quad",
        choices=["quad", "poly"],
        help="box type for ocr_infer region representation",
    )
    ...
    # params for ocr_infer recognizer
    parser.add_argument(
        "--rec_algorithm",
        type=str,
        default="CRNN",
    ...
    parser.add_argument(
        ...
        '"aspect-ratio-kept" resizing. Set W larger for longer ocr_infer.',
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="Whether to save images cropped from ocr_infer detection results.",
    )
    parser.add_argument(
        "--crop_res_save_dir", type=str, default="./output", help="Dir to save the cropped images for ocr_infer boxes"
    )
    parser.add_argument(
        "--visualize_output",
        type=str2bool,
